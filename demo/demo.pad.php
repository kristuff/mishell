...
Console::log(str_pad(Console::text('I am colorized with ::text() inside str_pad() {padLength:100, padString:\'*\'}', 'blue'), 100, '*'), 'white', 'blue');
Console::log('');   
...
Console::log(Console::pad(Console::text('I am colorized with ::text() inside ::pad() {padLength:100, padString:\'*\'}', 'blue'), 100, '*'), 'white', 'blue');
Console::log('');   
